...
int main(int, char**)
{
  ...
  setenv("OPENCV_FFMPEG_CAPTURE_OPTIONS", "rtsp_transport;tcp", 1);
    ...
    //cv::VideoCapture capture("rtsp://username:password@localhost:8554/user=username_password='password'_channel=channel_number_stream=0.sdp");
    cv::VideoCapture capture("rtsp://localhost:8554/test.sdp", cv::CAP_FFMPEG);
